...
bool lwnxCmdReadFloat32(lwSerialPort* Serial, uint8_t CommandId, float* Response) {
	return lwnxHandleManagedCmd(Serial, CommandId, (uint8_t*)Response, 4);
}
...
bool lwnxCmdWriteFloat32(lwSerialPort* Serial, uint8_t CommandId, float Value) {
	return lwnxHandleManagedCmd(Serial, CommandId, NULL, 0, true, (uint8_t*)&Value, 4);
}
